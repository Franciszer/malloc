...
static MunitResult
test_init(const MunitParameter params[], void* user_data) {
...
static MunitResult
test_push_front_single(const MunitParameter params[], void* user_data) {
    (void)params; (void)user_data;
...
static MunitResult
test_push_front_multiple(const MunitParameter params[], void* user_data) {
    (void)params; (void)user_data;

    ft_ll_node* head = NULL;
    item_t a = { .id = 1 }, b = { .id = 2 }, c = { .id = 3 };
    ft_ll_init(&a.node); ft_ll_init(&b.node); ft_ll_init(&c.node);
...
static MunitResult
test_push_back_order(const MunitParameter params[], void* user_data) {
    (void)params; (void)user_data;
...
static MunitResult
test_pop_front(const MunitParameter params[], void* user_data) {
    (void)params; (void)user_data;

    ft_ll_node* head = NULL;
    item_t a = { .id = 1 }, b = { .id = 2 };
    ft_ll_init(&a.node); ft_ll_init(&b.node);
...
static MunitResult
test_remove_positions(const MunitParameter params[], void* user_data) {
    (void)params; (void)user_data;

    ft_ll_node* head = NULL;
    item_t a = { .id = 1 }, b = { .id = 2 }, c = { .id = 3 }, d = { .id = 4 };
    ft_ll_init(&a.node); ft_ll_init(&b.node); ft_ll_init(&c.node); ft_ll_init(&d.node);
...
static MunitResult
test_iteration_and_safe_remove(const MunitParameter params[], void* user_data) {
    (void)params; (void)user_data;

    ft_ll_node* head = NULL;
    item_t n1 = { .id = 1 }, n2 = { .id = 2 }, n3 = { .id = 3 }, n4 = { .id = 4 }, n5 = { .id = 5 };
    ft_ll_init(&n1.node); ft_ll_init(&n2.node); ft_ll_init(&n3.node); ft_ll_init(&n4.node); ft_ll_init(&n5.node);
    ...
    int count = 0;
    FT_LL_FOR_EACH(it, head) { (void)it; count++; }
...
static MunitTest tests[] = {
    ...
    { "/iteration_and_safe_remove", test_iteration_and_safe_remove, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL },
    { NULL, NULL, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL }
};

static const MunitSuite suite = {
    "/linked_list", tests, NULL, 1, MUNIT_SUITE_OPTION_NONE
};
