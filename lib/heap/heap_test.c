...
/* ft_heap_show_alloc_mem() returns total of: tiny/ small blocks as bin sizes, plus exact large
 * sizes. */
...
static MunitTest tests[] = {
	{"/tiny_alloc_reuse_and_trim",
	 tiny_alloc_reuse_and_trim,
	 setup,
	 teardown,
	 MUNIT_TEST_OPTION_NONE,
	 NULL},
	{"/small_alloc_zone_lifetime",
	 small_alloc_zone_lifetime,
	 setup,
	 teardown,
	 MUNIT_TEST_OPTION_NONE,
	 NULL},
	{"/large_alloc_shrink_grow",
	 large_alloc_shrink_grow,
	 setup,
	 teardown,
	 MUNIT_TEST_OPTION_NONE,
	...
	{"/free_invalid_is_ignored",
	 ...
	 MUNIT_TEST_OPTION_NONE,
	 NULL},
	{"/show_alloc_mem_total_is_correct",
	 show_alloc_mem_total_is_correct,
	 setup,
	 teardown,
	 MUNIT_TEST_OPTION_NONE,
