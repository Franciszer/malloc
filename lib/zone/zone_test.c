...
static MunitResult
test_new_slab_and_blocks(const MunitParameter params[], void *ud) {
    (void)params; (void)ud;
...
static MunitResult
test_free_list_lifo(const MunitParameter params[], void *ud) {
    (void)params; (void)ud;
...
static MunitResult
test_contains_and_bounds(const MunitParameter params[], void *ud) {
    (void)params; (void)ud;
...
static MunitResult
test_large_zone(const MunitParameter params[], void *ud) {
    (void)params; (void)ud;
...
static const MunitSuite suite = {
    "/zone", tests, NULL, 1, MUNIT_SUITE_OPTION_NONE
};
