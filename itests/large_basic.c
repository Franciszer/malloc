...
/*   Updated: 2025/09/29 16:59:23 by frthierr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#include <stdlib.h>
#include <string.h>
#include "heap/heap.h"  // SMALL_BIN_SIZE

int main(void) {
    const size_t n1 = SMALL_BIN_SIZE + 1;   // large lower bound
    const size_t n2 = (SMALL_BIN_SIZE + 1) * 4;
